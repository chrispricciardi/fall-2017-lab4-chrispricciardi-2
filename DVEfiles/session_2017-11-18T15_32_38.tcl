...
# DVE full session
# Saved on Sat Nov 18 15:32:38 2017
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{530 235} {1833 977}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 377} {child_wave_right 921} {child_wave_colname 186} {child_wave_colvalue 186} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 21588997
